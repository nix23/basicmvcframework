<?php
	class Spot_Photo_Model extends Model
	{
		protected $table_name = "spots_photos";
		protected $db_fields  = array("id", "spot_id", "master_name", "main",
		...
		// Fetching main photo
		public function find_main_photo_on($spot_id)
		{
			$sql  = "WHERE spot_id = %d   ";
			$sql .= "  AND main    = 'yes'";
		...
		public function find_photos_on($spot_id,
												 $fetch_main = true)
		{
			$sql  = "WHERE spot_id = %d ";
