...
class Video_Stats_Model extends Model
{
    protected $table_name = "videos_stats";
    protected $db_fields = array("id", "video_id", "comments_count", "likes_count",
    ...
    public function find_stats_on($video_id)
    {
