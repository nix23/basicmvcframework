...
<div class="form">
	...
	<!-- User ID -->
	<input type="hidden" name="spot[user_id]" value="<?php echo $spot->user_id; ?>">
	<!-- User ID END -->
	...
	<div class="item">
		...
		<div class="legend">
			...
			<div class="description">
				Choose category,to which this spot will be attached.
			</div>
		</div>
	...
	<div class="item">
		...
		<div class="legend">
			...
			<div class="description">
				Other users can't see disabled spot.<br>
	...
	<div class="item">
		...
		<div class="legend">
			...
			<div class="description">
				You can specify spot author here.
			</div>
		</div>
	...
	<div class="item">
		...
		<div class="legend">
			...
			<div class="description">
				If it's required,you can specify this spot source link.
