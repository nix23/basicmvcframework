            ...
            <div class="add-button">
                <a href="<?php 
                                if($selected_subcategory)
                                    public_link("speed/form/add/" . $selected_subcategory->id);
                                else if($selected_category)
                                    public_link("speed/form/add/" . $selected_category->id);
                                else
                                    public_link("speed/form");
                            ?>">
                    <div class="wrapper">
                        <div class="name">
                    ...
                    <a href="<?php
                        ...
                        <div class="item-wrapper">
                            ...
                            <div class="info-small">
                                <div class="top">
                                    <?php echo views_to_compact_form($speed->views_count); ?>
                                </div>
