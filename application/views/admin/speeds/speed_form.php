...
<div class="form">
    ...
    <div class="item">
        ...
        <div class="legend">
            ...
            <div class="description">
                Choose speed's heading name.<br>
    ...
    <div class="item">
        ...
        <div class="element">
            <select name="speed[user_id]" class="select">
                <option value=""<?php
                                        if(!$is_editing)
                                            echo " selected";
                                      ?>>
    ...
    <div class="item">
        ...
        <div class="legend">
            <div class="name">
                Speed's article<span class="required">*</span>
            </div>
    ...
    <div class="item">
        ...
        <div class="element">
            <div class="radio">
                <input type="radio" name="speed[moderated]" value="yes"
                         <?php if($speed->moderated == "yes" or !$is_editing) echo "checked"; ?>>
                <span class="padding">
                    Yes
                </span>
            </div>
            ...
            <div class="radio newrow">
                <input type="radio" name="speed[moderated]" value="no"
                         <?php if($speed->moderated == "no") echo "checked"; ?>>
                <span class="padding">
                    No
                </span>
            </div>
    ...
    <div class="item">
        ...
        <div class="legend">
            ...
            <div class="description">
                If this speed isn't passing moderation,please specify reason.<br>
                Uploader will see it at drive module.
            </div>
        </div>

        <div class="element">
            <input type="text" name="speed[moderation_fail_text]" maxlength="255" class="input long"
                     value="<?php echo $speed->moderation_fail_text; ?>">
        </div>
