...
<div class="page-controls">
	...
	<div class="pagination">
		<div class="wrapper ajax-pagination">
			<?php include("spots_list_pagination.php"); ?>
		</div>
	</div>
	<!-- Pagination END -->
	...
	<div class="add-button">
		<a href="<?php 
						if($selected_subcategory)
							admin_link("spots/form/add/" . $selected_subcategory->id);
						else if($selected_category)
							admin_link("spots/form/add/" . $selected_category->id);
						else
							admin_link("spots/form");
					?>">
			<div class="wrapper">
				<div class="name">
...
<div class="page-content">
	...
	<div class="module-items-wrapper">
		<div class="module-items ajax-module-items">
			<?php include("spots_list_items.php"); ?>
		</div>
	...
	<div class="module-categories">
		<?php include("spots_list_categories.php"); ?>
	</div>
	<!-- Categories END -->
